...
main_menu() {
    ...
    echo "1. Manchester United itu berasal dari Alor Mengkudu"
    echo "2. Alor Mengkudu melahirkan ramai pemain bola berbakat besar"
    echo "3. Tahun demi tahun, pembagunan sukan di Alor Mengkudu sangat baik"
    echo "4. Semoga Alor Mengkudu terus meningkat jauh"
